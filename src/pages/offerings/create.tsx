...
export default function CreateOffering() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(data.error || 'Failed to create offering');
      }
    } catch (error) {
  ...
  return (
    <AuthGuard>
      <Head>
        <title>Create Offering - 313Connect</title>
        <meta name="description" content="Create a new offering" />
      </Head>
      ...
      <Container>
        ...
        <Main>
          <Title>Create New Offering</Title>
